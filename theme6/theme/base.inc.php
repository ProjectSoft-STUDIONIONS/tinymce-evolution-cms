...
$this->set('plugins', 'anchor visualblocks autolink autosave save advlist modxlink media table image code', 'string'); // https://www.tinymce.com/docs/get-started/basic-setup/#pluginconfiguration
