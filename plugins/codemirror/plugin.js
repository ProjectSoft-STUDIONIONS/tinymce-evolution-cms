...
!(function(doc, tiny){
	...
	tiny.PluginManager.add('codemirror', function(editor, url) {
		...
		function showSourceEditor() {
			...
			// Insert caret marker
			if (codeSettings.saveCursorPosition) {
			...
			var config = {
				...
				resizable: true,
				maximizable: true,
				fullScreen: false, //codeSettings.fullscreen,
		...
		if (tiny.majorVersion < 5) {
			...
			editor.addMenuItem('codemirror-view', {
				image: tiny.baseURL + '/plugins/codemirror/codemirror.svg',
				text: 'The source HTML code of the CodeMirror plugin',
				context: 'view',
				onclick: showSourceEditor,
