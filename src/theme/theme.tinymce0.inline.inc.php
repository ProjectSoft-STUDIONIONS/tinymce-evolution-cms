...
$this->set('plugins', 'autolink save emoticons image link', 'string');

$this->set('toolbar1', 'undo redo | formatselect | bold strikethrough | alignleft aligncenter alignright | link unlink image emoticons | help', 'string');
