 ...
 * @internal    @legacy_names %uppercase%
 * @internal    @installset base
 * @logo        /assets/plugins/%lowercase%/tinymce/logo.png
 * @reportissues %repository%
 * @documentation Plugin docs %issues%
 * @documentation Official %uppercase%-docs https://www.tinymce.com/docs/
 * @author       Чернышёв Андрей aka ProjectSoft <projectsoft2009@yandex.ru>, Deesen, yama
 * @lastupdate   %lastupdate%
 */
if (!defined('MODX_BASE_PATH')) { die('What are you doing? Get out of here!'); }

require(MODX_BASE_PATH."assets/plugins/%lowercase%/plugin.tinymce.inc.php");
