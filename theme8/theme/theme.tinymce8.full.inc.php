...
$this->set('plugins', 'autoresize anchor autolink advlist lists pagebreak table save modxlink image emoticons insertdatetime preview media searchreplace code directionality fullscreen visualchars nonbreaking autosave visualblocks charmap wordcount codesample codemirror', 'string');
...
$this->set('toolbar4', 'image media | link unlink anchor | table | pagebreak hr | codesample nonbreaking insertdatetime | charmap emoticons', 'string');
